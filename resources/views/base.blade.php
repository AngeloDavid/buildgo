  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-dark-success">
    ...
    <a href="index3.html" class="brand-link navbar-success">
      <img src="{{ asset('dist/img/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Build Cellar</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/marca/create')}}" class="nav-link">                  
                  <p>Nuevo</p>
                </a>
              </li>              
            </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/grupo/create')}}" class="nav-link">                  
                  <p>Nuevo</p>
                </a>
              </li> 
            </ul>
          </li>
          <li class="nav-header">HERMANOS</li>
          <li class="nav-item">
...
<!-- Bootstrap 4 -->
<scri src="{{ asset('plugins/bootstrap/js/bootstrap.min.js')}}"></scri pt>
